...
$(document).ready(function() {
    ...
    $('#activate-step-2').on('click', function(e) {
      ...
      $('#activate-step-9').on('click', function(e) {
        ...
        $('ul.setup-panel li:eq(0),ul.setup-panel li:eq(1),ul.setup-panel li:eq(2),ul.setup-panel li:eq(3),ul.setup-panel li:eq(4),ul.setup-panel li:eq(5),ul.setup-panel li:eq(6),ul.setup-panel li:eq(7),ul.setup-panel li:eq(8)').addClass('disabled');
    });       
});
